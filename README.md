...
**연락처**: abjin69@gmail.com | [GitHub](https://github.com/abjin) | [Velog](https://velog.io/@abjin)
...
### 고려대학교 DMIS 연구실 (2026.02 ~ 현재)
**Undergraduate Researcher** (Advisor: Prof. Jaewoo Kang)
- Visual Document Retrieval, OCR, Knowledge Agent 분야의 최신 논문 서베이 및 분석 수행

### 아이젠사이언스 (AIGEN Sciences) (2026.02 ~ 현재)
**Research Intern**
- 기업 내 시각적으로 풍부한 다양한 포맷의 문서에 대한 RAG 시스템 연구 및 개발
- 약물 시장성 조사 자동화 Agent 연구 및 개발
...
### 1. Visual Document Retrieval & Multi-modal RAG
현실 세계의 문서는 텍스트를 넘어, PPT·PDF·Excel 등 시각적으로 풍부한 포맷이 대부분입니다. 이러한 다양한 형태의 문서에 대한 멀티모달 RAG에 관심을 두고 있으며, 특히 Visual Document Retrieval 모델의 임베딩 저장 공간 효율을 높이는 전략을 탐구하고 있습니다.

### 2. Knowledge Agent
LLM이 외부 도구와 지식 소스를 자율적으로 탐색·활용하여 복잡한 질문에 답하는 Knowledge Agent 구조에 관심을 두고 있습니다. RAG 봇 및 LangGraph 기반 워크플로우 구현 경험을 바탕으로, 에이전트의 검색 전략 수립과 멀티스텝 추론 과정의 신뢰성 향상을 탐구하고 있습니다.
